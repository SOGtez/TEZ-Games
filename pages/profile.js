...
export default function ProfilePage() {
  ...
  return (
    <Layout title={player ? `${player.username} — TEZ Games` : 'Profile — TEZ Games'}>
      <style>{`
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          <div className="profile-grid">
            {[
              ...
              { label: 'Current Streak', value: player.current_streak || 0, icon: player.current_streak >= 3 ? '🔥' : '🎯' },
                  ...
                  <div key={key} style={{
                    ...
                    {gs.played === 0 ? (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        <Row label="Played" value={gs.played} />
                        <Row label="Wins" value={gs.wins} color="#4ade80" />
                        <Row label="Losses" value={gs.losses} color="#f87171" />
                        {meta.hasPush && <Row label="Pushes" value={gs.pushes} color="#fde047" />}
                        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 4, paddingTop: 8 }}>
                          <Row label="Win Rate" value={winRate(gs.wins, gs.played)} color="#a78bfa" />
                        </div>
                      </div>
                    )}
                  </div>
